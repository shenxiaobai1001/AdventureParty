...
namespace RPGCharacterAnims.Extensions
{
    ...
    public static class AnimatorExtensions
    {
		...
		/// <summary>
		/// Sets the animator to trigger dashing.
		/// </summary>
		/// <remarks>
		/// This builds upon the existing SetAnimationTrigger helper and allows you to provide contextual action information.
		/// </remarks>
		/// <param name="animator">The animator to act on.</param>
		/// <param name="dashType">The enum value to set.</param>
		public static void TriggerDash(this Animator animator, DashType dashType)
		{ animator.SetActionTrigger(AnimatorTrigger.DashTrigger, ( int )dashType); }
