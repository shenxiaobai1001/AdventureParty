...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        private void Awake()
        {
			...
			SetHandler(HandlerTypes.Dash, new Dash());
		...
		/// <summary>
		/// Dash the specified direction.
		///
		/// Use the "Dash" action for a friendly interface.
		/// </summary>
		/// <param name="direction">1-Backward, 2-Forward, 3-Left, 4-Right</param>
		public void Dash(DashType dashType)
		{
			animator.TriggerDash(dashType);
